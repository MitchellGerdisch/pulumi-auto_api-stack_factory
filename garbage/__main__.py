...
# Demo notes: 
# - launch ahead of time due to AWS taking forever to create RDS
# - During demo: Add db_password secret config; add bucket = aws.s3.Bucket("goo")
# - pulumi up and show changes due to password and new bucket
